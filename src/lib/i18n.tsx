...
export const dict = {
  es: {
    ...
    about: {
      eyebrow: "01 — Sobre mí",
      meta: "Evan Morales — Frontend / Full-Stack Developer · Ciudad de México · Remoto",
      think1: "Pienso en",
    ...
    skills: {
      ...
      features: {
        ...
        availDesc: "Para nuevos proyectos · CDMX / remoto.",
        availCta: "Escríbeme",
        online: "En línea",
        devxName: "DevX",
  ...
  en: {
    ...
    about: {
      eyebrow: "01 — About",
      meta: "Evan Morales — Frontend / Full-Stack Developer · Mexico City · Remote",
      think1: "I think in",
      detailsWord: "details",
      think2: ", I build for",
      scaleWord: "scale",
    ...
    skills: {
      ...
      features: {
        ...
        availName: "Available",
        availDesc: "For new projects · Mexico City / remote.",
        availCta: "Message me",
        online: "Online",
        devxName: "DevX",
